...
const PrivateSpaceCrowdsale = artifacts.require('PrivateSpaceCrowdsale');
//const RefundVault = artifacts.require('./RefundVault');
const TokenTimelock = artifacts.require('./TokenTimelock');

contract('PrivateSpaceCrowdsale', function([_, wallet, investor1, investor2, foundersFund, foundationFund, partnersFund]) {
  ...
  beforeEach(async function () {
    ...
    // Investor caps (min aprox 120€-Max Cap aprox 70.000€ )
    this.investorMinCap = ether(0.035);
    this.investorHardCap = ether(20);

    // DICO Stages
    this.preICOStage = 0;
    this.preICORate = 100000;
    this.ICOStage = 1;
    this.ICORate = 75000;
    this.postICOStage = 2;
    this.postICORate = 50000;
    ...
    this.crowdsale = await PrivateSapceCrowdsale.new(
      this.rate,
      this.wallet,
      this.token.address,
      this.cap,
...
/**
  ...
  */
  ...
  /**
  // Función Whitelist a añadir después del testing, añadir tambien contratos
  ...
  */
  ...
  // Función Refundable a añadir después del testing, añadir tambien contratos
  /**
   ...
   */
    ...
    describe('when the crowdsale stage is PreICO', function() {
      ...
      it('forwards funds to the wallet', async function () {
        ...
        expect(balance.toNumber()).to.be.above(ether(20)); ///ojo a esto debería tener más por que wallet ya disponia de fondos
      });
    });
...
///Cambiar minimum cap , not possible because of eth fees
